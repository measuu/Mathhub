...
weight_units = {"g": 1, "kg": 1000, "t": 1_000_000}

speed_units = {"m/s": 1, "km/h": 1 / 3.6, "mph": 0.44704}

time_units = {"s": 1, "min": 60, "h": 3600, "day": 86400}
...
def convert_units(
    ...
    raise HTTPException(
        status_code=400, detail="Непідтримувані одиниці для конвертації"
    )
